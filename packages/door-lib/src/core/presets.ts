...
> = {
  ...
  "biohazard-1996-b02-blue-panel-double-door": {
    id: "biohazard-1996-b02-blue-panel-double-door",
    label: "1-1 B-2 Blue Panel Double Door",
    type: "double",
    motion: "hinge-double",
    material: "aged-wood-panel",
    frontTextureUrl: biohazard1996B02BluePanel,
    edgeTextureUrl: biohazard1996B02BluePanel,
    backTextureUrl: biohazard1996B02BluePanel,
